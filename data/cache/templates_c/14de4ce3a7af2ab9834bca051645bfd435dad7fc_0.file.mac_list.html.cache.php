...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d11ec65b15158_46271522',
...
function content_5d11ec65b15158_46271522 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '8046734075d11ec65aa3cc8_54432347';
?>
<!DOCTYPE html>
...
>
<?php echo '<script'; ?>
 src="./resource/js/bootstrapValidator.min.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="./resource/js/bootstrapValidator-zh_CN.js"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
...
>
    $('#mytab').bootstrapTable({
        url: 'index.php?c=mac&a=list&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
',
        method: 'get', 
...
function save_mac()
{
	...
	if (!mac_id) {
	    ...
	    $.ajax({
	        type:"POST",
	        url:'index.php?c=mac&a=insert&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
',
	        data:params,
	        dataType:'json',
	    ...
	    $.ajax({
	        type:"POST",
	        url:'index.php?c=mac&a=update&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
',
	        data:params,
	        dataType:'json',
	        success:function (responce) {
...
function edit_mac(id)
{
    ...
    $.ajax({
        type:"POST",
        url:'index.php?c=mac&a=search&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
',
        data:{'id':id},
        dataType:'json',
        success:function (responce) {
...
function delete_mac(id)
{
	$.showConfirm('确定要删除此mac数据吗？', function () {
	    ...
	    $.ajax({
	        type:"POST",
	        url:'index.php?c=mac&a=delete&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
',
	        data:{'id':id},
	        dataType:'json',
	        success:function (responce) {
